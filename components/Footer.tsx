...
export default function Footer() {
  const links = ["About Us", "Contact", "Returns", "Privacy Policy", "FAQ"]
    ...
    <footer className="footer">
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginBottom: "16px" }}>
        ...
        <a href="https://instagram.com/your_handle" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
          style={{ color: "#aaa", transition: "color 0.2s", display: "flex", alignItems: "center" }}
        ...
        {/* Facebook */}
        <a href="https://facebook.com/your_page" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
          style={{ color: "#aaa", transition: "color 0.2s", display: "flex", alignItems: "center" }}
        ...
        {/* Fiverr */}
        <a href="https://fiverr.com/your_username" target="_blank" rel="noopener noreferrer" aria-label="Fiverr"
          style={{ color: "#aaa", transition: "color 0.2s", display: "flex", alignItems: "center" }}
